...
public class DeliverToFleetListActivity extends BaseActivity implements Recycler_ItemClickCallBack, Recycler_AcceptedJobClickCallBack {
    ...
    public static String TAG = DeliverToFleetListActivity.class.getSimpleName();
 ...
 /*   private void openFutileDialogue(){
        ...
        alert.setPositive("Submit", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(YouEditTextValue!=null && YouEditTextValue.trim().length()>0){
                    ...
                    pd = LogCustom.loderProgressDialog2(DeliverToFleetListActivity.this);
                    pd.show();
                    Call<CommonResponse> call = apiService.updateStatusFutile(prefManager.getLogin_Token(), Constants.API_KEY, prefManager.getId(),jobId,"9", String.valueOf(getLocation.getcurrntLataLong().getLatitude()), String.valueOf(getLocation.getcurrntLataLong().getLongitude()), prefManager.getTruckId(),YouEditTextValue);
                    call.enqueue(new Callback<CommonResponse>() {
                        @Override
                        public void onResponse(Call<CommonResponse> call, Response<CommonResponse> response) {
                            pd.dismiss();
                            DeliverToFleetListActivity.this.finish();
        ...
        alert.setNegative("Cancel", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
...
/*
        ...
        String selecteddata = i.getStringExtra("selectedlist");
        Type listType = new TypeToken<ArrayList<JobModel>>(){}.getType();

        jobModelsList = new Gson().fromJson(selecteddata,listType);
*/

        this.recyclerview.setHasFixedSize(true);
        this.recyclerview.setLayoutManager(new LinearLayoutManager(DeliverToFleetListActivity.this, LinearLayoutManager.VERTICAL, false));
        this.recyclerview.setNestedScrollingEnabled(false);
        recyclerview.setEmptyView(emptyView);

        GetLocation getLocation = new GetLocation(DeliverToFleetListActivity.this);
...
//????
            ...
            public void onResponse(Call<FleetListResponse> call, Response<FleetListResponse> response) {
                ...
                if (response.body().getStatus().equals("true")) {
                    ...
                    if (response.body().getMessage().equals("invalidToken")) {
                        ...
                        Intent intent = new Intent(DeliverToFleetListActivity.this, Login_Activity.class);
    ...
    public void setAddapter() {
        custom_manu_adepter = new DeliveryToDepoFleetList_Adepter(DeliverToFleetListActivity.this, fleetResponseList, DeliverToFleetListActivity.this);
...
//                for(int i = 0 ; i<jobModelsList.size();i++)
//                {
//                    if(i == 0) {
//                        try {
//                            call_addJobToFleet(jobModelsList.get(i), fb.getId(), true);
//                        } catch (Exception e) {
//                            e.printStackTrace();
//                        }
//                    }
...
//                    {
//                        try {
//                            call_addJobToFleet(jobModelsList.get(i), fb.getId(), false);
//                        } catch (Exception e) {
//                            e.printStackTrace();
//                        }
//                    }
//                }
               ...
               // FleetResponse fb = stream(fleetResponseList).where(c -> c.isSelected() == true).first();
                ...
                Intent i = new Intent(DeliverToFleetListActivity.this, DeliverToDepoListActivity.class);
    ...
    public void homeDilog() {
        ...
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(DeliverToFleetListActivity.this);
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                Intent intent = new Intent(DeliverToFleetListActivity.this, MainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
    ...
    public void logOutDialog() {
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                showOdometerDialog(DeliverToFleetListActivity.this);
            }
        });
