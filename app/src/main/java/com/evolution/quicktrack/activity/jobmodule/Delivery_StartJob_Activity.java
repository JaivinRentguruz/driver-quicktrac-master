...
public class Delivery_StartJob_Activity extends BaseActivity {
    ...
    public static String TAG = Delivery_StartJob_Activity.class.getSimpleName();
    String jobId="";
    ...
    protected void onStart() {
        ...
        getLocation  =new GetLocation(Delivery_StartJob_Activity.this);
        initView();
    ...
    protected int getLayoutResourceId() {
        return R.layout.activity_delivery_start_location;
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.img_start:
                ...
                if(getLocation.getcurrntLataLong()!=null) {
                    call_updatestaus(jobId,Constants.AtDeliveryLocation,String.valueOf(getLocation.getcurrntLataLong().getLatitude()),String.valueOf(getLocation.getcurrntLataLong().getLongitude()),true);
                ...
                /*Intent intent=new Intent(Delivery_StartJob_Activity.this,JobDetailsDelivery_Activity.class);
...
*/
    ...
    public  void homeDilog(){
        ...
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Delivery_StartJob_Activity.this);
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                Intent intent = new Intent(Delivery_StartJob_Activity.this, MainActivity.class);
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
              ...
              /*  trackDriver.call_trackDriverAPi(Constants.BACK_LOGOUT);
                ...
                Intent   intent =new Intent(Delivery_StartJob_Activity.this,Login_Activity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_CLEAR_TASK);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
                finish();
*/
                showOdometerDialog(Delivery_StartJob_Activity.this);
            }
        });
    ...
    private void call_jobdetailsApi( )  {
        ...
        PrefManager prefManager = new PrefManager(Delivery_StartJob_Activity.this);
    ...
    public boolean validLocation(){
        ...
        if(getLocation.getcurrntLataLong()!=null){
            ...
            LogCustom.logd("xxxxxxxx","distance:"+distance(startPoint.getLatitude(),startPoint.getLongitude(),endPoint.getLatitude(),endPoint.getLongitude()));
