...
public class PickupDocket_Activity extends BaseActivity {
    ...
    LinearLayout photo_pickup_sign;
    // For Multiple Image
    @BindView(R.id.img_1)
    ImageView img1;
    ...
    @BindView(R.id.ll_col_comp)
    LinearLayout ll_col_comp;

    @BindView(R.id.ll_col_add)
    LinearLayout ll_col_add;

    @BindView(R.id.ll_del_comp)
    LinearLayout ll_del_comp;

    @BindView(R.id.ll_del_add)
    LinearLayout ll_del_add;
   ...
   /* @BindView(R.id.sign_consignee)
    ...
    public static String TAG = PickupDocket_Activity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ll_col_comp.setVisibility(View.VISIBLE);
        ll_col_add.setVisibility(View.VISIBLE);
        ll_del_comp.setVisibility(View.GONE);
        ll_del_add.setVisibility(View.GONE);
    ...
    protected void onStart() {
        super.onStart();
        getLocation  =new GetLocation(PickupDocket_Activity.this);
    }
    ...
    public void getIntendata() {
        ...
        txt_dc_title.setText("Proof Of PickUp");
        ...
        if(getIntent()!=null && getIntent().getExtras()!=null && getIntent().getExtras().containsKey("strIDs") && getIntent().getExtras().getString("strIDs").trim().length()>0){
           strIDs =  getIntent().getExtras().getString("strIDs");
            ...
            ll_col_comp.setVisibility(View.GONE);
            ll_col_add.setVisibility(View.GONE);
            ll_del_comp.setVisibility(View.GONE);
            ll_del_add.setVisibility(View.GONE);
        }else{
            callApi();
    ...
    @OnClick({ R.id.photo_pickup_sign, R.id.img_close1, R.id.img_close2, R.id.img_close3, R.id.img_close4, R.id.img_close5, R.id.btn_submit, R.id.img_details})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.img_details:
                ...
                Intent intent = new Intent(PickupDocket_Activity.this, JobDetailsView_Activity.class);
                ...
                try {
                    ...
                    else
                    {
                        if(response.body().getMessage().equals("invalidToken"))
                        {
                            ...
                            Intent   intent =new Intent(PickupDocket_Activity.this,Login_Activity.class);
    ...
    public void callSlip_Api(){
       ...
       // File filecosign=new File(images.get(0).getPath());
        ...
        //MultipartBody.Part fileToUpload2 = MultipartBody.Part.createFormData("docketpickupslip_sign[]", filecosign.getName(), mFile2);
      ...
      /*  if(docateSlipNumber.equals(""))
        ...
        List<MultipartBody.Part> pickupLocationImages = new ArrayList<>();
        for (int i = 0; i < images.size(); i++) {
            ...
            pickupLocationImages.add( MultipartBody.Part.createFormData("docketpickupslip_picture[]", file2.getName(), surveyBody));
        }
        ...
        Call<CommonResponse> call = apiService.docketpickupslip(
                APIKEY,
                driverid,
                token,
                jobid,
                number,
                pickupLocationImages
        );
            ...
            public void onResponse(Call<CommonResponse> call, Response<CommonResponse> response) {
                ...
                try {
                    if (response != null) {
                        Log.d(TAG, " : check status : " + response.body().toString());
                        if (response.body().getStatus().equals(Constants.API_STATUS)) {
                            call_updatestaus(jobId,Constants.PickUp,String.valueOf(getLocation.getcurrntLataLong().getLatitude()), String.valueOf(getLocation.getcurrntLataLong().getLongitude()));
                            prefManager.setKEYJobstatus("");
                            prefManager.setKEYJobId("");
                            Intent intent2 = new Intent(PickupDocket_Activity.this, AcceptedJobActivity.class);
    ...
    public boolean validdata(){
       ...
       // if(Utility.isValidString(editDocketnumber.getText().toString().trim())){
            if(images.size()>0){
                ...
                LogCustom.Toast(PickupDocket_Activity.this,"Please add Image");

                return false;
            }

      /*  }else {
            LogCustom.Toast(PickupDocket_Activity.this,"Please enter Number");
    ...
    public  void homeDilog(){
        ...
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(PickupDocket_Activity.this);
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                Intent intent = new Intent(PickupDocket_Activity.this, MainActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_CLEAR_TASK);
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(intent);
    ...
    public  void logOutDialog(){
        ...
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                showOdometerDialog(PickupDocket_Activity.this);
