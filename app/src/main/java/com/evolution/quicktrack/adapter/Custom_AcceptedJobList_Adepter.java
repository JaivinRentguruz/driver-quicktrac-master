...
public class Custom_AcceptedJobList_Adepter extends RecyclerView.Adapter<Custom_AcceptedJobList_Adepter.ViewHolder> {
    ...
    public Custom_AcceptedJobList_Adepter(Context context, List<JobModel> myDataset, Recycler_AcceptedJobClickCallBack callBack) {
        dataItems = myDataset;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        LayoutInflater inflater = LayoutInflater.from(
                parent.getContext());
        View v =
                inflater.inflate(R.layout.custom_accepted_joblist, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        if(QuickTrackAplication.IsNotNull(dataitem))
        {
            ...
            if(QuickTrackAplication.IsNotNull(dataitem.isIspickup())) {
                ...
                {
                    holder.txt_collection_name.setText("COLLECTION COMPANY:");
                    holder.txt_collection.setText(dataitem.getCollectionCompany());
                    holder.txt_jobtype.setText("Pickup Job");
                    if(dataitem.getType().equals(Constants.Job.JOB_1))
                    {
                        holder.btn_startJob.setText("PickUp From Depo");
                    }
                    else
                    {
                ...
                {
                    holder.txt_collection_name.setText("DELIVERY COMPANY:");
                    holder.txt_collection.setText(dataitem.getDeliveryCompany());
...
*/
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.txt_collection_label)
